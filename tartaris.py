...
def main():
    ...
    pygame.display.set_caption('Shape Plummet')

    showTextScreen('Shape Plummet')
    while True: # game loop
        if random.randint(0,1) == 0:
            pygame.mixer.music.load('videogames.mp3')
        else:
            pygame.mixer.music.load('videogames.mp3')
...
def drawBox(boxx, boxy, color, pixelx=None, pixely=None):
    ...
    pygame.draw.rect(DISPLAYSURF, LIGHTCOLORS[random.randint(0, len(COLORS)-1)], (pixelx + 1, pixely + 1, BOXSIZE - 4, BOXSIZE - 4))
